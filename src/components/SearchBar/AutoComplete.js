...
class AutoComplete extends React.Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (nextProps.autoHighlight &&
      (this.props.value !== nextProps.value || this.state.highlightedIndex ===
        null)) {
    ...
    Enter (event) {
      ...
      if (!this.isOpen()) {
        ...
        this.setState({
          ...
          //when no item is selected go to page search
        ...
        event.preventDefault()
        const item = this.getFilteredItems(
          this.props)[this.state.highlightedIndex]
        ...
        this.setState({
          ...
          this.props.history.push('/movie/play')
        })
      }
    },
  ...
  maybeAutoCompleteText (state, props) {
    ...
    const matchedItem = items[index] && props.isItemSelectable(items[index])
      ? items[index]
      : null
    ...
    return (
      <div style={{...this.props.wrapperStyle}} {...this.props.wrapperProps}>
        {this.props.renderInput({
          ...
          onKeyDown: this.composeEventHandlers(this.handleKeyDown,
            inputProps.onKeyDown),
          onClick: this.composeEventHandlers(this.handleInputClick,
            inputProps.onClick),
